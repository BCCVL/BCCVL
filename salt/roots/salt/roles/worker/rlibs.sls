...
{% set rpkgs = [
    ...
    {'name': 'caret',         'version': '6.0-76',  'hash': 'b4b81834fe1ec0a7b1ae767ecf5f9acf1b08f81a'},
    ...
    {'name': 'dismo',         'version': '1.1-1',   'hash': 'ebce750ae57e9d92083924785e7100f1c5d1f97e'},
    ...
    {'name': 'lazyeval',      'version': '0.2.0',   'hash': '2629047349122c97bf0aa2d5dd14732658c79590'},
    {'name': 'lme4',          'version': '1.1-11',  'hash': 'f260b2f95a02f78cf59f93ebdd8b2147fad3a465'},
    ...
    {'name': 'nlme',          'version': '3.1-123', 'hash': '23027ab2a2bd347153571dc236aa6c70f60593e5'},
    ...
    {'name': 'ordinal',       'version': '2015.1-21','hash': '12f5ea8778bd7232b161bf86ae612cbd79ac3b3e'},
    ...
    {'name': 'quantreg',      'version': '5.33',    'hash': '571943e14296f904381998a38f8e9c7b4becb8de'},
    ...
    {'name': 'scales',        'version': '0.4.1',   'hash': '91080dcbbe8eafa15002758262269ddd9e69e63d'},
    {'name': 'sp',            'version': '1.2-4',   'hash': '3453c6c3429c85942a579d720037c6c8c4b874d4'},
    ...
    {'name': 'tibble',        'version': '1.3.0',   'hash': 'a21806b3dab848307ac12680e21250bae76d2089'},
