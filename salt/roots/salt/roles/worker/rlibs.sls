...
{% set rpkgs = [
  ...
  {'name': 'reshape',      'version': '0.8.4',   'hash': 'sha1=f6ee061fac8129c39733ed890bf2cf117fa1d94a'},
  {'name': 'biomod2',      'version': '3.1-64',  'hash': 'sha1=1f378ea62d8b3f55ec55b4a9818d251388db1ef4'},
